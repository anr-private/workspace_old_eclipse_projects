package com.maranr.anr_listview_chk_fancy;
...
/** 
 * Fancy checkbox listview
 * List items have text and icon/image.
 * Also shows header and footer on the list.
 * Also uses styles to alter appearance of header and footer text.
